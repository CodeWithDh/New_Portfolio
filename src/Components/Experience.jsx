        ...
        <div className="Experience">
            ...
            <div className="work">
                <div className="content">
                    ...
                    <h6 class="workHeading"> <PhoneAndroidIcon style={{transform: "rotate(15deg)",translateY:"110",color:"#FF4040"}}/> Smart Mobile Shop</h6> <span id="workTag"> Local Vendor</span>
                    <p className="tech"></p>
                    <p className="details">
            ...
            <div className="work">
                <div className="content">
                    ...
                    <h6 class="workHeading"><FoodBankIcon style={{marginBottom:"5px",fontSize:"1.7rem",color:"#FF4040"}}/> Meat Hub</h6> <span id="workTag">College Major Project + Sold To vendor <span> {/* effect of showing details div*/} </span></span>
                    <p className="tech"></p>
                    <p className="details">
